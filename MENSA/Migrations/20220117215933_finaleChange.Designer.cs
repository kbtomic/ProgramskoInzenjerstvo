...
namespace MENSA.Migrations
{
    ...
    [Migration("20220117215933_finaleChange")]
    partial class finaleChange
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MENSA.Models.NewNarudzba", b =>
                {
                    b.HasOne("MENSA.Models.Menu", "Menu1")
                        .WithMany()
                        .HasForeignKey("Menu1Id");

                    b.HasOne("MENSA.Models.Menu", "Menu2")
                        .WithMany()
                        .HasForeignKey("Menu2Id");

                    b.HasOne("MENSA.Models.Menu", "Menu3")
                        .WithMany()
                        .HasForeignKey("Menu3Id");

                    b.HasOne("MENSA.Models.Menu", "Menu4")
                        .WithMany()
                        .HasForeignKey("Menu4Id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MENSA.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
